...
const EditInventoryDialog = ({ open, onClose, currentRow }) => {
  //console.log('171', currentRow);
  const subtext = currentRow && currentRow.upc ? currentRow.upc : '';
  const subtext2 = currentRow && currentRow.manufacturer ? currentRow.manufacturer : '';
  const subtext3 = currentRow && currentRow.purchase_cost ? currentRow.purchase_cost : '';
  const subtext4 = currentRow && currentRow.name ? currentRow.name : '';
  const subtext5 = currentRow && currentRow.category ? currentRow.category : '';
  const subtext6 = currentRow && currentRow.description ? currentRow.description : '';

  
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
      <DialogTitle>Edit this Inventory</DialogTitle>
      <Formik
        initialValues={{
          productType: '',
          skuCode: subtext,
          manufacturerName: subtext2,
          machineCost: subtext3,
          productImage: '',
          productName: subtext4,
          unit: '',
          category: subtext5,
          tag: '',
          description: subtext6,
          measurementUnit:'',
        }}
        ...
        onSubmit={(values) => {
          ...
          console.log(values);  
          const response = InventoryDetailAPIs.InventoryDetailPut(currentRow.id, values);
          response.then(()=>{
